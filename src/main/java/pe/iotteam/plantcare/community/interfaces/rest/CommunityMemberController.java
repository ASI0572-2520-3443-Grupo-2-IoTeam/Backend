...
public class CommunityMemberController {
         ...
         */
        @Operation(summary = "Registrar un nuevo miembro de la comunidad", description = "Crea un nuevo registro de miembro para el usuario especificado. "
        ...
        public ResponseEntity<CommunityMemberResource> registerMember(
                ...
                CommunityMember member = membershipCommandService.registerMember(userId, user.getRole());
                return ResponseEntity.ok(CommunityMemberResourceAssembler.toResource(member, user.getUsername()));
        }
         ...
         * public ResponseEntity<CommunityMemberResource> promoteToAdmin(@PathVariable
         * UUID userId) {
         * CommunityMember member = membershipCommandService.promoteToAdmin(userId);
         * return
         * ResponseEntity.ok(CommunityMemberResourceAssembler.toResource(member));
         * }
         */
         ...
         * public ResponseEntity<CommunityMemberResource> demoteToUser(@PathVariable
         * UUID userId) {
         ...
         */
        @Operation(summary = "Listar todos los miembros registrados", description = "Devuelve la lista completa de miembros pertenecientes a la comunidad.")
        @ApiResponses(value = {
                ...
                var members = memberRepository.findAll()
                                ...
                                .map(member -> {
                                        String username = userRepository.findById(member.getId())
                                                        ...
                                                        .orElse("Unknown");
                                        return CommunityMemberResourceAssembler.toResource(member, username);
                                })
                                .toList();
