...
@Tag(name = "Community Posts", description = "Endpoints para la gestión de publicaciones dentro de la comunidad de PlantCare")
public class PostController {
        ...
        @Operation(summary = "Crear una nueva publicación", description = "Permite que un usuario registrado cree una publicación en la comunidad. "
        ...
        @Operation(summary = "Obtener todas las publicaciones", description = "Devuelve una lista completa de publicaciones ordenadas por fecha de creación, "
        ...
        @Operation(summary = "Eliminar una publicación propia", description = "Permite que un usuario elimine una publicación que le pertenece. "
